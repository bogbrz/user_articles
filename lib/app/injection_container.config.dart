...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.ArticlesContentRepository>(() =>
        _i9.ArticlesContentRepository(
            remoteDataSource: gh<_i4.ArticlesRemoteRetrofitDataSource>()));
    gh.factory<_i10.ArticlesCubit>(() =>
        _i10.ArticlesCubit(articlesRepository: gh<_i5.ArticlesRepository>()));
    gh.factory<_i11.ArticlesContentCubit>(() => _i11.ArticlesContentCubit(
        articlesContentRepository: gh<_i9.ArticlesContentRepository>()));
    return this;
  }
}
